        ...
        <div class="relative flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
            ...
            <div class="relative flex w-full max-w-md flex-col gap-6">
                <a href="{{ route('home') }}" class="flex flex-col items-center gap-2 font-medium" wire:navigate>
                    <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 to-indigo-700 shadow-sm">
                        <x-app-logo-icon class="size-6 fill-current text-white" />
                    </span>

                    <span class="text-sm font-semibold text-zinc-700 dark:text-zinc-300">e-commerce</span>
                </a>

                <div class="flex flex-col gap-6">
                    <div class="relative overflow-hidden rounded-xl border bg-white dark:bg-stone-950 dark:border-stone-800 text-stone-800 shadow-xs">
                        <div class="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-indigo-500 via-emerald-500 to-amber-500"></div>
                        <div class="px-10 py-8 pt-9">{{ $slot }}</div>
                    </div>
                </div>
            </div>
        </div>
